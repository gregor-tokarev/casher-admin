...
//
// const navList = [
//   { name: "Продукты", link: "/products", icon: "cart" },
//   { name: "Заказы", link: "/orders", icon: "dollar" },
//   { name: "Пользователи", link: "/users", icon: "user" },
//   { name: "Менеджеры", link: "/managers", icon: "key" },
//   { name: "Категории", link: "/categories", icon: "list" },
// ];
//
// const user = {
//   name: "Valentin",
